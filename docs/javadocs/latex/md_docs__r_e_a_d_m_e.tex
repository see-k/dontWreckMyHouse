\DoxyHorRuler
 \hypertarget{md_docs__r_e_a_d_m_e_autotoc_md0}{}\doxysection{Don\textquotesingle{}t Wreck My House}\label{md_docs__r_e_a_d_m_e_autotoc_md0}
\hypertarget{md_docs__r_e_a_d_m_e_autotoc_md1}{}\doxysubsubsection{Dev10 Assessment\+: M05}\label{md_docs__r_e_a_d_m_e_autotoc_md1}
\hypertarget{md_docs__r_e_a_d_m_e_autotoc_md2}{}\doxyparagraph{by Chike Okonta}\label{md_docs__r_e_a_d_m_e_autotoc_md2}
\hypertarget{md_docs__r_e_a_d_m_e_autotoc_md3}{}\doxyparagraph{04/19/2021}\label{md_docs__r_e_a_d_m_e_autotoc_md3}
💻 Designed using Intelij

\DoxyHorRuler
 \hypertarget{md_docs__r_e_a_d_m_e_autotoc_md4}{}\doxysubsubsection{Introduction}\label{md_docs__r_e_a_d_m_e_autotoc_md4}
\href{https://stage3talent.brightspace.com/d2l/le/content/6716/viewContent/3713/View}{\texttt{ Don\textquotesingle{}t wreck my house}} ~\newline
 
\begin{DoxyCode}{0}
\DoxyCodeLine{+ This is an application that allows a user to reserve accommodations for a guest with a host.}
\DoxyCodeLine{+ A guest chooses a place to stay for a specific date range. }
\DoxyCodeLine{+ If the host location is available, it may be reserved by the guest. }
\DoxyCodeLine{+ Reserved locations are not available to other guests during reserved dates.}
\end{DoxyCode}


\DoxyHorRuler
 \hypertarget{md_docs__r_e_a_d_m_e_autotoc_md5}{}\doxysubsubsection{High Level Requirements}\label{md_docs__r_e_a_d_m_e_autotoc_md5}
The application user is an accommodation administrator. They pair guests to hosts to make reservations.


\begin{DoxyItemize}
\item The administrator may view existing reservations for a host.
\item The administrator may create a reservation for a guest with a host.
\item The administrator may edit existing reservations.
\item The administrator may cancel a future reservation.
\end{DoxyItemize}

\DoxyHorRuler
 \hypertarget{md_docs__r_e_a_d_m_e_autotoc_md6}{}\doxysubsubsection{Instructions}\label{md_docs__r_e_a_d_m_e_autotoc_md6}
To launch the application
\begin{DoxyItemize}
\item open terminal and navigate to the \mbox{\hyperlink{_app_8java}{App.\+java}} file in the src folder
\item compile the program -\/-\/$>$javac \mbox{\hyperlink{_app_8java}{App.\+java}}
\item launch the program -\/-\/$>$ java App
\end{DoxyItemize}\hypertarget{md_docs__r_e_a_d_m_e_autotoc_md7}{}\doxyparagraph{Code Step Sequence}\label{md_docs__r_e_a_d_m_e_autotoc_md7}

\begin{DoxyItemize}
\item \mbox{[} \mbox{]} Step 1 (Set Up)
\begin{DoxyItemize}
\item \mbox{[} \mbox{]} Print header for introduction
\item \mbox{[} \mbox{]} Show {\ttfamily menu} \mbox{[}0-\/4\mbox{]}
\end{DoxyItemize}
\item \mbox{[} \mbox{]} Step 2 (Perform event)
\begin{DoxyItemize}
\item \mbox{[} \mbox{]} Get user\textquotesingle{}s {\ttfamily response} to menu
\item \mbox{[} \mbox{]} Execute {\ttfamily event} based on user\textquotesingle{}s response
\begin{DoxyItemize}
\item \mbox{[} \mbox{]} 0\+: Exit
\item \mbox{[} \mbox{]} 1\+: View Reservations for host
\item \mbox{[} \mbox{]} 2\+: Make a reservation
\item \mbox{[} \mbox{]} 3\+: Edit a reservation
\item \mbox{[} \mbox{]} 4\+: Cancel a reservation
\end{DoxyItemize}
\item \mbox{[} \mbox{]} Call corresponding layer based on requested event
\begin{DoxyItemize}
\item \mbox{[} \mbox{]} User Interface
\item \mbox{[} \mbox{]} Domain
\item \mbox{[} \mbox{]} Data Access
\item \mbox{[} \mbox{]} Model
\end{DoxyItemize}
\item \mbox{[} \mbox{]} Data in repository / file M\+U\+ST be consistent with all {\ttfamily C\+R\+UD} events executed
\end{DoxyItemize}
\item \mbox{[} \mbox{]} Step 3 (exit)
\begin{DoxyItemize}
\item \mbox{[} \mbox{]} Exit App if {\ttfamily event} request is 0
\end{DoxyItemize}
\end{DoxyItemize}

\DoxyHorRuler
 \hypertarget{md_docs__r_e_a_d_m_e_autotoc_md8}{}\doxysubsection{Example of Console Execution}\label{md_docs__r_e_a_d_m_e_autotoc_md8}
\hypertarget{md_docs__r_e_a_d_m_e_autotoc_md9}{}\doxyparagraph{Making Reservations}\label{md_docs__r_e_a_d_m_e_autotoc_md9}
 \hypertarget{md_docs__r_e_a_d_m_e_autotoc_md10}{}\doxyparagraph{Changing Reservations}\label{md_docs__r_e_a_d_m_e_autotoc_md10}


Figure 3

\DoxyHorRuler
\hypertarget{md_docs__r_e_a_d_m_e_autotoc_md11}{}\doxysubsection{Project Management}\label{md_docs__r_e_a_d_m_e_autotoc_md11}

\begin{DoxyCode}{0}
\DoxyCodeLine{+ Use link below to go to project board}
\end{DoxyCode}
 \href{https://trello.com/b/XkHJu36o}{\texttt{ Link to Public Trello Board\+: M\+O5 Mastery Project}}\hypertarget{md_docs__r_e_a_d_m_e_autotoc_md12}{}\doxysubsection{Time Tracker}\label{md_docs__r_e_a_d_m_e_autotoc_md12}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{6}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ D\+A\+TE  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ T\+A\+SK ID  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ E\+S\+T\+I\+M\+A\+T\+ED T\+I\+ME (H\+RS)  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ S\+T\+A\+RT T\+I\+ME (H\+RS\+:M\+I\+NS)  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ E\+ND T\+I\+ME (H\+RS\+:M\+I\+NS)  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ S\+T\+A\+T\+US   }\\\cline{1-6}
\endfirsthead
\hline
\endfoot
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ D\+A\+TE  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ T\+A\+SK ID  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ E\+S\+T\+I\+M\+A\+T\+ED T\+I\+ME (H\+RS)  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ S\+T\+A\+RT T\+I\+ME (H\+RS\+:M\+I\+NS)  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ E\+ND T\+I\+ME (H\+RS\+:M\+I\+NS)  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ S\+T\+A\+T\+US   }\\\cline{1-6}
\endhead
\PBS\centering 4.\+12.\+2021  &\PBS\centering Research  &\PBS\centering 4  &\PBS\centering 2\+:00 PM  &\PBS\centering 4\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+13.\+2021  &\PBS\centering Planning  &\PBS\centering 4  &\PBS\centering 12\+:00 PM  &\PBS\centering 4\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+13.\+2021  &\PBS\centering Setup Packages and models  &\PBS\centering 1  &\PBS\centering 10\+:00 AM  &\PBS\centering 11\+:00 AM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+14.\+2021  &\PBS\centering Implement Guest Repository  &\PBS\centering 2  &\PBS\centering 3\+:00 PM  &\PBS\centering 3\+:48 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+14.\+2021  &\PBS\centering Implement Host Repository  &\PBS\centering 2  &\PBS\centering 9\+:00 AM  &\PBS\centering 9\+:43 AM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+14.\+2021  &\PBS\centering Implement Reservation Repository  &\PBS\centering 2  &\PBS\centering 4\+:00 PM  &\PBS\centering 4\+:40PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+14.\+2021  &\PBS\centering Test Host Repository  &\PBS\centering 2  &\PBS\centering 9\+:00 AM  &\PBS\centering 9\+:30 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+14.\+2021  &\PBS\centering Test Guest Repository  &\PBS\centering 2  &\PBS\centering 3\+:00 PM  &\PBS\centering 3\+:48 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+14.\+2021  &\PBS\centering Test Reservation Repository  &\PBS\centering 2  &\PBS\centering 4\+:00 PM  &\PBS\centering 4\+:40 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+14.\+2021  &\PBS\centering First Progress presentation  &\PBS\centering 0.\+25  &\PBS\centering 10\+:00 AM  &\PBS\centering 10\+:15 AM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+15.\+2021  &\PBS\centering Implement Host Services  &\PBS\centering 2  &\PBS\centering 10\+:30 PM  &\PBS\centering 11\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+15.\+2021  &\PBS\centering Implement Guest Services  &\PBS\centering 2  &\PBS\centering 1\+:30 PM  &\PBS\centering 2\+:45 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+15.\+2021  &\PBS\centering Implement Reservation Services  &\PBS\centering 2  &\PBS\centering 10\+:30 PM  &\PBS\centering 11\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+17.\+2021  &\PBS\centering Test Host Services  &\PBS\centering 2  &\PBS\centering 10\+:00 AM  &\PBS\centering 2\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+17.\+2021  &\PBS\centering Test Guest Services  &\PBS\centering 2  &\PBS\centering 10\+:00 AM  &\PBS\centering 2\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+17.\+2021  &\PBS\centering Test Reservation Services  &\PBS\centering 2  &\PBS\centering 10\+:00 AM  &\PBS\centering 2\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+16.\+2021  &\PBS\centering Implement View class  &\PBS\centering 1  &\PBS\centering 9\+:00 AM  &\PBS\centering 10\+:00 AM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+16.\+2021  &\PBS\centering Implement Controller class  &\PBS\centering 1  &\PBS\centering 10\+:00 AM  &\PBS\centering 10\+:00 AM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+16.\+2021  &\PBS\centering Implement App class  &\PBS\centering 0.\+5  &\PBS\centering 9\+:00 PM  &\PBS\centering 9\+:15 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+16.\+2021  &\PBS\centering Spring Annotations  &\PBS\centering 0.\+5  &\PBS\centering 9\+:00 PM  &\PBS\centering 9\+:05 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+16.\+2021  &\PBS\centering Second Progress presentation  &\PBS\centering 0.\+25  &\PBS\centering 10\+:15 AM  &\PBS\centering 10\+:30 AM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+16.\+2021  &\PBS\centering Update Tests for 100\% coverage  &\PBS\centering 0.\+5  &\PBS\centering 10\+:00 AM  &\PBS\centering 2\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+16.\+2021  &\PBS\centering Stretch Goal \#1  &\PBS\centering 4  &\PBS\centering 6\+:00 PM  &\PBS\centering 10\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+17.\+2021  &\PBS\centering Stretch Goal \#2  &\PBS\centering 4  &\PBS\centering 6\+:00 PM  &\PBS\centering 10\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+17.\+2021  &\PBS\centering Bugs\+: find and fix \#1  &\PBS\centering 1  &\PBS\centering 6\+:00 PM  &\PBS\centering 10\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+17.\+2021  &\PBS\centering Update Documentation, Javadoc, H\+T\+ML page  &\PBS\centering 0.\+5  &\PBS\centering 10\+:00 AM  &\PBS\centering 2\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\PBS\centering 4.\+17.\+2021  &\PBS\centering Final Test\+: attempt to break code  &\PBS\centering 0.\+5  &\PBS\centering 10\+:00 AM  &\PBS\centering 2\+:00 PM  &\PBS\centering Completed   \\\cline{1-6}
\end{longtabu}
...
\DoxyHorRuler
 \hypertarget{md_docs__r_e_a_d_m_e_autotoc_md16}{}\doxysubsection{Sequence Diagram}\label{md_docs__r_e_a_d_m_e_autotoc_md16}

\begin{DoxyCode}{0}
\DoxyCodeLine{+ Click  to view in full page}
\end{DoxyCode}
 

\DoxyHorRuler
 \hypertarget{md_docs__r_e_a_d_m_e_autotoc_md17}{}\doxysubsubsection{Notes}\label{md_docs__r_e_a_d_m_e_autotoc_md17}
Project will have an additional H\+T\+ML page with additional explanation on methods and classes \href{https://github.com/see-k/dontWreckMyHouse}{\texttt{ link}}\hypertarget{md_docs__r_e_a_d_m_e_autotoc_md18}{}\doxysubsubsection{Glossary}\label{md_docs__r_e_a_d_m_e_autotoc_md18}

\begin{DoxyItemize}
\item Guest\+: A customer. Someone who wants to book a place to stay. Guest data is provided via a zip download.
\item Host\+: The accommodation provider. Someone who has a property to rent per night. Host data is provided.
\item Location\+: A rental property. In Don\textquotesingle{}t Wreck My House, Location and Host are combined. The application enforces a limit on one Location per Host, so we can think of a Host and Location as a single thing.
\item Reservation\+: One or more days where a Guest has exclusive access to a Location (or Host). Reservation data is provided.
\item Adminstrator\+: The application user. Guests and Hosts don\textquotesingle{}t book their own Reservations. The Administrator does it for them.
\end{DoxyItemize}\hypertarget{md_docs__r_e_a_d_m_e_autotoc_md19}{}\doxyparagraph{Data Information}\label{md_docs__r_e_a_d_m_e_autotoc_md19}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ D\+A\+TA  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ T\+Y\+PE   }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ D\+A\+TA  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ T\+Y\+PE   }\\\cline{1-2}
\endhead
\PBS\centering {\ttfamily Last Name}  &\PBS\centering {\ttfamily String}   \\\cline{1-2}
\PBS\centering {\ttfamily First Name}  &\PBS\centering {\ttfamily Integer}   \\\cline{1-2}
\PBS\centering {\ttfamily State}  &\PBS\centering {\ttfamily String}   \\\cline{1-2}
\PBS\centering {\ttfamily File/\+Path}  &\PBS\centering {\ttfamily String}   \\\cline{1-2}
\PBS\centering {\ttfamily Date}  &\PBS\centering {\ttfamily Local\+Date}   \\\cline{1-2}
\PBS\centering {\ttfamily Category}  &\PBS\centering {\ttfamily E\+N\+UM}   \\\cline{1-2}
\end{longtabu}
